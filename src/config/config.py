...
class Config:
    ...
    # 讯飞语音识别API配置
    XUNFEI_API_KEY = os.getenv('XUNFEI_API_KEY', '2cd533b30c559f0e94bc77d5c2d12e34')
    XUNFEI_API_SECRET = os.getenv('XUNFEI_API_SECRET', 'MDJlZTJlNTQ0ZjJjYWEzOThjZGFjYjE2')
